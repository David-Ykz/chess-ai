...
inline constexpr int midgamePieceValues[12] = {82, 337, 365, 477, 1025, 0, -82, -337, -365, -477, -1025, 0};
inline constexpr int endgamePieceValues[12] = {94, 281, 297, 512, 936, 0, -94, -281, -297, -512, -936, 0};
inline constexpr int midgamePst[14][64] = {
    // White Pawn
    {
        0,    0,    0,    0,    0,    0,    0,    0,
...
inline constexpr int endgamePst[14][64] = {
    // White Pawn
    {
        0,    0,    0,    0,    0,    0,    0,    0,
        13,    8,    8,   10,   13,    0,    2,   -7,
